...
template<typename T>
struct _slang_vector_traits;

#define SLANG_VECTOR_TRAITS_1(vector_type, element_type, element_count) \
    template<>                                                          \
    struct _slang_vector_traits<vector_type>                            \
    {                                                                   \
...
#define SLANG_VECTOR_TRAITS(element_type)                   \
    SLANG_VECTOR_TRAITS_1(element_type##1, element_type, 1) \
    SLANG_VECTOR_TRAITS_1(element_type##2, element_type, 2) \
    SLANG_VECTOR_TRAITS_1(element_type##4, element_type, 4)

SLANG_VECTOR_TRAITS(int)
SLANG_VECTOR_TRAITS(uint)
SLANG_VECTOR_TRAITS(short)
SLANG_VECTOR_TRAITS(ushort)
SLANG_VECTOR_TRAITS(char)
SLANG_VECTOR_TRAITS(uchar)
SLANG_VECTOR_TRAITS(longlong)
SLANG_VECTOR_TRAITS(ulonglong)
SLANG_VECTOR_TRAITS(float)
SLANG_VECTOR_TRAITS(double)
